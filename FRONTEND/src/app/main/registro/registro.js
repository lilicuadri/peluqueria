...
import FirebaseLoginTab from './FirebaseRegistroTab';
...
const Registro = props => {
  ...
  return (
    <div className="flex flex-col flex-auto p-16 sm:p-24 md:flex-row md:p-0 overflow-hidden" style={{ marginTop:'15px' }}>
