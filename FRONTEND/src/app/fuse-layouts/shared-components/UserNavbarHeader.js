...
function UserNavbarHeader(props) {
  ...
  return (
    ...
    >
      <Typography className="username text-14 whitespace-nowrap font-semibold mb-4" color="inherit">
      {ObjSesion?  ObjSesion.Usuario.NombreCompleto  :""}
      </Typography>
      <Typography
        className="email text-13 opacity-50 whitespace-nowrap font-medium"
        color="inherit"
      >
        {ObjSesion?  ObjSesion.Usuario.Email  :""}
      </Typography>
