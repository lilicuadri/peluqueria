...
module.exports = () => {
  ...
  requestsRouter.post(
    "/peluquerias/actualizar",
    peluqueriasController.actualizar
  );
  ...
  requestsRouter.get(
    "/usuarios/listarPorIdentificacion/:value/:key",
    usuariosController.listarPorIdentificacion
  );
  ...
  requestsRouter.get(
    "/turnos/listarMisTurno/:value/:key",
  ...
  //cronogramas
  requestsRouter.get(
    "/cronogramas/listar/:value",
    cronogramasController.listar
  );
  ...
  requestsRouter.post(
    ...
    cronogramasController.consultar
  );
  ...
  //departamentos
  requestsRouter.get(
    "/departamentos/listar/:value",
    departamentosController.listar
  );
  requestsRouter.get(
    "/departamentos/:key/:value",
    departamentosController.buscar
  );
  requestsRouter.post(
  ...
  requestsRouter.post(
    "/departamentos/consultar",
    departamentosController.consultar
  );
